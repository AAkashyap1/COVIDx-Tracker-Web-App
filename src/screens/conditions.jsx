const symptoms = [
  { name: 'A Chronic Lung Disease', description: 'COPD, asthma, etc.' },
  { name: 'Heart Condition', description: 'Clogged arteries, heart disease, heart attack, or heart failure' },
  { name: 'Cancer', description: 'Any type' },
  { name: 'Weakened Immune System', description: 'Including using medicaitons that suppress the immune system' },
  { name: 'Blood Disorder', description: 'Thalassemia or sickle cell anemia' },
  { name: 'HIV', description: '' },
  { name: 'Obesity', description: '' },
  { name: 'High Blood Pressure', description: '' },
  { name: 'Down Syndrome', description: '' },
  { name: 'Diabetes', description: '' },
  { name: 'Kidney or Liver Disease', description: '' },
]
                    ...
                    <div className="bg-white shadow rounded-lg">
                        <div className="px-4 py-5 sm:px-6">
                            <h2 id="applicant-information-title" className="text-lg leading-6 font-medium text-gray-900">
                                Which of the following underlying medical conditions do you have?
                            </h2>
