                ...
                <section aria-labelledby="applicant-information-title">
                    <div className="bg-white shadow rounded-lg">
                        <div className="px-4 py-5 sm:px-6">
                            ...
                            our <span className="text-blue-550"><a href="https://docs.google.com/document/d/e/2PACX-1vTzpHrZRHCwdBOiIIhdciuXFDZ_HXsevDoIeB81Urr_ozdTA3qEiHNpDk30H9d1xOItWUt4S1p_i-no/pub"
                            target="_blank" rel="noreferrer"> privacy policy and terms of use</a></span>, as well as 
