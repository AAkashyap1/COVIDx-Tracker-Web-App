            ...
            <div className="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8">
                <div className="mt-8 border-t border-blue-550 pt-5 md:flex md:items-center md:justify-between">
                    <p className="mt-5 text-base text-gray-400 md:mt-0 md:order-1">
                        View <span className="text-blue-550"><a href="https://docs.google.com/document/d/e/2PACX-1vTzpHrZRHCwdBOiIIhdciuXFDZ_HXsevDoIeB81Urr_ozdTA3qEiHNpDk30H9d1xOItWUt4S1p_i-no/pub"
                        target="_blank" rel="noreferrer"> here </a></span> for privacy policy and terms of use. All information used in this tool is provided by the 
